...
vgrf_data, vgrf_labels, imu_data, imu_labels = generate_dummy_data(
    ...
    vgrf_features=2, imu_features=12, 
    num_classes=5
)
...
encoder = RepresentationEncoder(input_features=12, embedding_dim=64)
...
| `IMU_FEATURES` | 12 | Number of features in IMU data |
...
IMU data shape: torch.Size([1000, 128, 12]), Labels: [0 1 3 4]
