...
vgrf_data, vgrf_labels, imu_data, imu_labels = generate_dummy_data(
    num_samples=1000, seq_len=100, 
    vgrf_features=6, imu_features=6, 
    num_classes=5
)
...
| `SEQ_LEN` | 100 | Sequence length for time-series data |
| `VGRF_FEATURES` | 6 | Number of features in VGRF data |
...
VGRF data shape: torch.Size([1000, 100, 6]), Labels: [0 1 2 3]
IMU data shape: torch.Size([1000, 100, 6]), Labels: [0 1 3 4]
